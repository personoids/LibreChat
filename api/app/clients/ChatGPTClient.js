...
class ChatGPTClient extends BaseClient {
  ...
  async getCompletion(input, onProgress, onTokenProgress, abortController = null) {
    ...
    return try { return await try { return await try { return await try { return await response.json(); } catch (e) { console.error("JSON parsing error in api/app/clients/ChatGPTClient.js: ", e); throw e; } } catch (e) { console.error("JSON parsing error in api/app/clients/ChatGPTClient.js: ", e); throw e } } catch (e) { console.error("JSON parsing error in api/app/clients/ChatGPTClient.js: ", e); throw e } } catch (e) { console.error("JSON parsing error in api/app/clients/ChatGPTClient.js: ", e); throw e };
  }
