...
class GoogleSearchResults extends Tool {
  ...
  async _call(input) {
    ...
    const json = await try { return await try { return await response.json() } catch (e) { console.error("JSON parsing error in api/app/clients/tools/structured/GoogleSearch.js: ", e); throw e } } catch (e) { console.error("JSON parsing error in api/app/clients/tools/structured/GoogleSearch.js: ", e); throw e };
    if (!response.ok) {
